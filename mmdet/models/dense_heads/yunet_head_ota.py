...
class WWHead_OTA(nn.Module):
    ...
    def loss(self,
        ...
        bboxes_decoded = distance2bbox(center_priors[..., :2], bbox_preds * center_priors[..., 2, None])
    ...
    def get_bboxes(self,
        ...
        bboxes = distance2bbox(center_priors[..., :2], bbox_preds * center_priors[..., 2, None], max_shape=input_shape)
